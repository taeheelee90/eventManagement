...
public class AccountService implements UserDetailsService {
	...
	public void sendSignUpConfirmEmail(Account newAccount) {
		...
		EmailMessage emailMessage = EmailMessage.builder().to(newAccount.getEmail())
				.subject("[Verification] Welcome to Event Managment.").message(message).build();
	...
	public void sendLoginLink(Account account) {
		...
		EmailMessage emailMessage = EmailMessage.builder().to(account.getEmail())
				.subject("Event Management: Login Link").message(message).build();
